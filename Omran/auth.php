...
<body style="background-attachment:fixed;background:url(images/bg1.png) repeat">
     ...
     <!-- POPUP --> 
  	...
  	<div id="form" style="top:35%;left:35%;width:330px;padding:15px;background-color:white; box-shadow: 8px 8px 6px rgba(0,0,0,0.8);position:fixed;z-index:1500000000;border-radius:20px;background:rgba(230,230,230,1);display:none">
  		...
  		<div id="message" style="background:white;text-align:center;padding:20px;vertical-align:middle"></div>
  	</div>
	...
	<div class="corp">
      ...
      <div style="margin-top:60px;margin-bottom:60px" class="container">
		<section id="content">
    		...
    		<div id="verif" style="display:none;color:red;z-index:100;box-shadow:0px 0px 4px black;position:absolute;background-color:white;width:200px;height:35px;right:-172px;top:95px;text-shadow:0px 0px 3px rgba(0,0,0,0.3)"><span style="height:px;width:0px;position:absolute;left:-26px;top:4px;border:13px solid transparent;border-right:13px solid white"></span></div>
    
			<form onsubmit="return false;" onkeypress="if (event.keyCode == 13)authentification()">
				<h1>Login Form</h1>
				<div>
				...
				<div>
					<input type="submit" value="Log in" onclick="authentification()" />
					<a onclick="forgot2()" style="cursor:pointer">mot de passe oublié?</a>
