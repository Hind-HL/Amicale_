...
<table class="ds_box" style="z-index:9999999900000" cellpadding="0" cellspacing="0" id="ds_conclass" style="display: none;">
			<tr>
...
<div style="width:1025px;height:38px;background:#FFF;margin-bottom:25px;border-radius:4px;border:groove 2px;margin-left:auto;margin-right:auto;box-shadow:2px 2px 8px rgba(51,51,51,0.3);background-image:radial-gradient(rgba(252,252,252,1),rgba(245,245,245,1))">
    ...
    <div class="corp">
        ...
        <ul id="nav" style="margin-top:5px">
			<li id="MenuEvent1" class="current" onclick="Decouvert()"><a >Décourvrir</a></li>
			<li id="MenuEvent2" onclick="EventAvnir()"><a >Event à venir</a></li>
			<li id="MenuEvent3"><a >Propositions<!--<img src="images/multi.png" border="0" width="15" height="15" alt="" align="absmiddle"> si il ya un sous bloc--></a>
				<ul>
					<li><a onclick="PropoEvent()">Proposer Event</a></li>
					<li><a onclick="MesPropos()">Mes Propositions</a></li>
                    <li><a onclick="LesPropos()">Propositions en vote</a></li>
                    <?php if($_SESSION['statue']=='admin' || $_SESSION['statue']=='membre'){ ?>
                    <li><a onclick="GestPropos()">Gestion des Propositions</a></li>
                    <li><a onclick="HistVote()">Historique du vote</a></li>
                    <?php }?>
				</ul>
			</li>	
			<li id="MenuEvent4"><a onclick="Dotations()">Dotations</a></li>
            <?php if($_SESSION['statue']=='admin' || $_SESSION['statue']=='membre'){ ?>
            <li id="MenuEvent5"><a onclick="GestEvent()">Gestion Events</a></li>
            <li id="MenuEvent6"><a>Gestion dotations</a>
            	<ul>
                	<li><a onclick="AjtDot()">Ajouter dotation</a></li>
                    <li><a onclick="SpDot()">Supprimer dotation</a></li>
                </ul>
            </li>
			...
			<span id="sana"><center><h4 style="color:rgba(72,164,255,1)">Activités relatives a l'année : <select id="sanaton" onchange="an = this.value;deroulement(an)"></select></h4></center></span>
    ...
    <script type="application/javascript">
            	document.getElementById('sanaton').innerHTML=CalAn()
				setTimeout(function(){HonaActiv=document.getElementById("hona").innerHTML},1500);
				EventCour=1
